...
import PSCSS (bottom, center, circle, closestSide, currentColor, deg, ellipse, farthestCorner, left, linearGradient, nil, pct, px, radialGradient, repeating, right, top, transparent, (~))
  ...
  describe "Images Module" do
    ...
    describe "radial-gradient()" do
      ...
      "radial-gradient(circle farthest-corner at center,#ffff00,#000000)"
        `isRenderedFrom` do
        radialGradient (circle ~ farthestCorner) center $ rgb 255 255 0 /\ black
